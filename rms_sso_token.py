...
Usage (command line):
    python rms_sso_token.py \
        ...
        --panel ask-sarika --expires-in 300
...
def mint_token(secret: str, user: str, name: str, role: str = "Employee",
...
if __name__ == "__main__":
    ...
    p.add_argument("--user", required=True, help="Employee ID")
    ...
    tok = mint_token(args.secret, args.user, args.name, args.role, args.expires_in)
